...
6. EVERY non-screenshot, non-PDF-doc image you see (reference_photo, sketch_with_measurements, inspiration, receipt) MUST appear in at least one new_line's source_image_indexes OR in a new_expense's source_image_index. If a sketch shows measurements for the fireplace, attach it to the fireplace line. If a reference photo shows the existing room, attach it to the most relevant line in that area. Do not leave images orphaned — the contractor needs them visible on the lines they describe.
