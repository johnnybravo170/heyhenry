        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {factor
              ...
              : "You'll need a free authenticator app on your phone. Here's how it works."}
          </DialogDescription>
        </DialogHeader>
        ...
        {!factor ? (
          <>
            <div className="space-y-3 text-sm">
              <p className="text-muted-foreground">
                Two-factor authentication adds a second step at login: a 6-digit code that changes
                every 30 seconds, generated by an app on your phone. Even if someone learns your
              ...
              <div className="rounded-md border bg-muted/40 p-3">
                ...
                <ol className="list-decimal space-y-1.5 pl-5 text-muted-foreground">
                  <li>
                    Install a free authenticator app on your phone — we recommend{' '}
                    ...
                    <span className="font-medium text-foreground">1Password</span>.
                  </li>
                  <li>On the next screen, scan the QR code with that app.</li>
                  <li>The app shows a 6-digit code. Type it in to finish.</li>
                </ol>
              </div>
              <p className="text-xs text-muted-foreground">
                Already use a password manager (1Password, Bitwarden)? It can store this too.
              </p>
            </div>
            <DialogFooter>
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            <ol className="list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
              <li>
                Open your authenticator app and tap the &ldquo;+&rdquo; (or &ldquo;Scan&rdquo;).
              </li>
              <li>Point your phone&apos;s camera at the code below.</li>
              <li>Enter the 6-digit code the app shows you.</li>
            </ol>
