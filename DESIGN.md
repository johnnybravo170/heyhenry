...
- **Scale (px):** 11 · 12 · 14 · 16 · 20 · 24 · 28 · 36  *(13px is off-scale — use 14px)*
...
- **Buttons (primary):** ink fill `#0A0A0A`, white label, 9px radius, 34px height, 12px padding-inline, font 14/600. Hover: lift to `#222`. **One rust (`bg-brand`) primary per screen** — the single high-intent CTA. All other primaries stay ink.
...
- ✅ One ink, one accent. Use rust for CTAs only — at most one rust primary per screen.
